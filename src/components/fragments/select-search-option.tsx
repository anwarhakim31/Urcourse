      ...
      <PopoverTrigger asChild>
        <FormControl>
          <Button
            ...
            role="combobox"
            className={cn(
              "relative w-full h-9 p-2 justify-between text-sm font-normal hover:text-muted-foreground hover:bg-transparent",
          ...
          >
            {field.value
              ? data?.find((item) => item.id === field.value)?.value
              : placeholder}
            <ChevronsUpDown className="opacity-50 absolute right-3" />
          </Button>
        </FormControl>
      </PopoverTrigger>
